...
contract BatasmChef is Ownable {
    ...
    IBatasmStaking public rewardMinter;
    ...
    function add(
        ...
        require(poolInfo.length <= MAX_NUM_OF_POOLS, "BatasmChef::add: > MAX_NUM_OF_POOLS");
    ...
    function setRewardPerSecond(uint256 _rewardPerSecond) public onlyOwner {
        require(_rewardPerSecond <= MAX_REWARD_PER_SECOND, "BatasmChef::setRewardPerSecond: > MAX_REWARD_PER_SECOND");
        massUpdatePools();
    ...
    function setRewardMinter(IBatasmStaking _rewardMinter) external {
        require(address(rewardMinter) == address(0), "BatasmChef::setRewardMinter: Cannot redefine rewardMinter");
